...
PASS_TYPE = "Play_Pass" # "pass"
# DRIBBLE_TYPE = "Play_Dribble"
...
def actions(
    ...
    _, ax = field(ax=ax, color=color, figsize=figsize, show=False)
    ...
    if action_type is None:
        m, n = location.shape
        action_type = [PASS_TYPE for i in range(m)]
        # if label is None:
        #     show_legend = False
    ...
    eventmarkerdict = {PASS_TYPE: "o"}
    for eventtype in event_types:
        if eventtype != PASS_TYPE:
