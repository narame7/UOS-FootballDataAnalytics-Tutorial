...
본 리포지토리는 서울시립대학교 **'축구 데이터 분석'** 수업의 실습 튜토리얼 자료 소개를 위해 만들어졌습니다. 축구 경기 데이터를 활용하여 데이터 정제, 탐색적 데이터 분석(EDA), 시각화 및 모델링, 인공지능 모델링 등을 통해 의미 있는 인사이트를 도출하는 것을 목표로 합니다.<br>
