...
def generate_pitch_control_for_event(event_id, frame, event, tracking_home, tracking_away, params, GK_numbers, field_dimen = (106.,68.,), n_grid_cells_x = 50, offsides=True):
    ...
    ball_start_pos = np.array([event['Start X'], event['Start Y']])
